    ...
    <div class="container m-auto p-2">
        <section class="py-8 px-4 text-center">
            <div class="max-w-auto mx-auto">
                ...
                <h2 class="mt-8 uppercase text-xl lg:text-2xl font-black">Server error. Please try again later.</h2>
                <a href="/" class="mt-6  inline-block uppercase bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150">Back To Homepage</a>
            </div>
        </section>
    </div>
</body>
